...
class CurrencyActivity : AppCompatActivity(), Contract.View, INetworkChange {
    ...
    @Inject lateinit var currencyPresenter : Contract.Presenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        currencyPresenter.onAttachView(this, applicationContext)
    ...
    private fun recalcCurrency(){
        ...
        currencyPresenter.checkSourceCurrency(currSum.text.toString().toFloat(), currencyFrom.selectedItem.toString(), currencyTo.selectedItem.toString())
    }

    override fun onCurrencyChanged(sum: Float, kursConvert: Float, source: EnumSource) {
        recalcSum.text = sum.toString()
        currConvert.text = kursConvert.toString()
        this.source.text = source.value
        progressCircular.visibility = View.GONE
    }

    override fun getSharedPref(): SharedPreferences = pref
